...
function afficherTableau(tab) {
    ...
    document.getElementById("mot").innerHTML = doc;
}
...
function afficherMauvaisesLettres(listeLettres) {
    var doc = "<br> Les lettres non présentes sont ";
    var taille = listeLettres.length;
    for (let i = 0; i < taille; i++) {
        if (i == taille - 1) // evite la , après la dernière lettre
        {
            doc += listeLettres[i] + "<br>";
        }
        else {
            doc += listeLettres[i] + ",";
        }
    }
    document.getElementById("lettre").innerHTML = doc;
}
...
function lancerPartie(niveau) {
    ...
    document.getElementById("mottrouver").innerHTML = (motATrouver + "<br>");
    ...
    do {
        ...
        console.log("Positions" + lesPositions);
    ...
    dessinerPendu(nbErreur);
    if (gagne == 1) {
        document.getElementById("result").innerHTML = ("Bravo!! vous avez gagné. Le mot était " + motATrouver + "<br>");
    }
    else {
