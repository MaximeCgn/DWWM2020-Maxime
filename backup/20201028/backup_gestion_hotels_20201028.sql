...
INSERT INTO `chambres` VALUES (1,101,2,1,1,'2020-10-28 11:59:40',NULL),(2,102,1,2,1,'2020-10-28 11:59:40',NULL),(3,103,1,1,1,'2020-10-28 11:59:40',NULL),(4,104,1,2,2,'2020-10-28 11:59:40',NULL),(5,105,1,2,2,'2020-10-28 11:59:40',NULL),(6,106,1,1,2,'2020-10-28 11:59:40',NULL),(7,107,1,3,3,'2020-10-28 11:59:40',NULL),(8,108,1,1,3,'2020-10-28 11:59:40',NULL),(9,109,1,2,3,'2020-10-28 11:59:40',NULL),(10,235,1,1,4,'2020-10-28 11:59:40',NULL),(11,157,1,1,4,'2020-10-28 11:59:40',NULL),(12,874,1,1,7,'2020-10-28 11:59:40',NULL),(13,125,1,5,7,'2020-10-28 11:59:40',NULL),(14,101,1,3,6,'2020-10-28 11:59:40',NULL),(15,102,1,3,6,'2020-10-28 11:59:40',NULL),(16,103,1,2,10,'2020-10-28 11:59:40',NULL),(17,104,1,3,15,'2020-10-28 11:59:40',NULL),(18,105,1,3,6,'2020-10-28 11:59:40',NULL),(19,106,1,1,15,'2020-10-28 11:59:40',NULL),(20,107,1,1,11,'2020-10-28 11:59:40',NULL),(21,108,1,2,13,'2020-10-28 11:59:40',NULL),(22,109,1,2,10,'2020-10-28 11:59:40',NULL),(23,235,1,3,12,'2020-10-28 11:59:40',NULL),(24,157,1,1,11,'2020-10-28 11:59:40',NULL),(25,874,1,2,7,'2020-10-28 11:59:40',NULL),(26,125,1,1,9,'2020-10-28 11:59:40',NULL),(27,101,1,3,8,'2020-10-28 11:59:40',NULL),(28,102,1,3,15,'2020-10-28 11:59:40',NULL),(29,103,1,1,11,'2020-10-28 11:59:40',NULL),(30,104,1,1,11,'2020-10-28 11:59:40',NULL),(31,105,1,1,13,'2020-10-28 11:59:40',NULL),(32,106,1,2,15,'2020-10-28 11:59:40',NULL),(33,107,1,2,12,'2020-10-28 11:59:40',NULL),(34,108,1,1,9,'2020-10-28 11:59:40',NULL),(35,109,1,3,13,'2020-10-28 11:59:40',NULL),(36,235,1,3,8,'2020-10-28 11:59:40',NULL),(37,157,1,3,14,'2020-10-28 11:59:40',NULL),(38,874,1,1,8,'2020-10-28 11:59:40',NULL),(39,125,1,2,10,'2020-10-28 11:59:40',NULL);
...
/*!50001 VIEW `stationchambre` AS select `stations`.`idStation` AS `idStation`,`stations`.`nomStation` AS `nomStation`,`stations`.`altitudeStation` AS `altitudeStation`,`hotels`.`nomHotel` AS `nomHotel`,`hotels`.`categorieHotel` AS `categorieHotel`,`hotels`.`adresseHotel` AS `adresseHotel`,`hotels`.`villeHotel` AS `villeHotel`,`chambres`.`IdChambre` AS `idChambre`,`chambres`.`numChambre` AS `numChambre`,`chambres`.`typeChambre` AS `typeChambre`,`chambres`.`capaciteChambre` AS `capaciteChambre`,`chambres`.`idHotel` AS `idHotel` from ((`stations` join `hotels` on((`stations`.`idStation` = `hotels`.`idStation`))) join `chambres` on((`hotels`.`idHotel` = `chambres`.`idHotel`))) */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `stationchambreleft` AS select `stations`.`idStation` AS `idStation`,`stations`.`nomStation` AS `nomStation`,`stations`.`altitudeStation` AS `altitudeStation`,`hotels`.`nomHotel` AS `nomHotel`,`hotels`.`categorieHotel` AS `categorieHotel`,`hotels`.`adresseHotel` AS `adresseHotel`,`hotels`.`villeHotel` AS `villeHotel`,`hotels`.`idHotel` AS `idHotel`,`chambres`.`IdChambre` AS `idChambre`,`chambres`.`numChambre` AS `numChambre`,`chambres`.`typeChambre` AS `typeChambre`,`chambres`.`capaciteChambre` AS `capaciteChambre` from ((`stations` left join `hotels` on((`stations`.`idStation` = `hotels`.`idStation`))) left join `chambres` on((`hotels`.`idHotel` = `chambres`.`idHotel`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2020-10-28 17:10:01
