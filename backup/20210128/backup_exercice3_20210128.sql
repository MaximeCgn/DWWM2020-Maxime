...
INSERT INTO `etudiants` VALUES (1,'ROBLIN','LEA','12,bd de la liberte','calais',62100,'21345678','2014-09-01',1,'','F','1995-01-14',NULL),(2,'MACARTHUR','LEON','121,bd gambetta','calais',62100,'21-30-65-09','2014-09-01',1,'','M','1994-04-12',NULL),(3,'MINOL','LUC','9,rue des prairies','boulogne',62200,'21-30-20-10','2014-09-01',1,'','M','1997-03-12',NULL),(4,'BAGNOLE','SOPHIE','12,rue des capucines','wimereux',62930,'21-89-04-30','2014-09-01',1,'','F','1996-03-21',NULL),(5,'BURY','MARC','67,allee ronde','marcq',62300,'21-90-87-65','2014-09-01',1,'','M','1993-02-05',NULL),(6,'VENDRAUX','MARC','5,rue de marseille','calais',62100,'21-96-00-09','2013-09-01',1,'a redouble sa premiere annee','M','1996-01-21',NULL),(7,'VENDERMAELE','HELENE','456,rue de paris','boulogne',62200,'21-45-45-60','2014-09-01',1,'','F','1995-03-30',NULL),(8,'BESSON','LOIC','3,allee carpentier','dunkerque',59300,'28-90-89-78','2014-09-01',2,'','M','1994-05-21',NULL),(9,'GODART','JEAN-PAUL','123,rue de lens','marck',59870,'28-09-87-65','2013-09-01',2,'a double sa seconde annee','M','1993-01-12',NULL),(10,'BEAUX','MARIE','1,allee des cygnes','dunkerque',59100,'21-30-87-90','2014-09-01',2,NULL,'F','1996-04-12',NULL),(11,'TURINI','ELSA','12,route de paris','boulogne',62200,'21-32-47-97','2014-09-01',2,NULL,'F','1996-07-17',NULL),(12,'TORELLE','ELISE','123,vallee du denacre','boulogne',62200,'21-67-86-90','2014-09-01',2,NULL,'F','1997-04-16',NULL),(13,'PHARIS','PIERRE','12,avenue foch','calais',62100,'21-21-85-90','2014-09-01',2,NULL,'M','1996-03-18',NULL),(14,'EPHYRE','LUC','12,rue de lyon','calais',62100,'21-35-32-90','2014-09-01',2,NULL,'M','1995-01-21',NULL),(15,'LECLERCQ','JULES','12,allee des ravins','boulogne',62200,'21-36-71-92','2014-09-01',2,NULL,'M','1994-05-19',NULL),(16,'DUPONT','LUC','21,avenue monsigny','calais',62200,'21-21-34-99','2014-09-01',2,NULL,'M','1996-11-02',NULL),(17,'MARKE','LOIC','312,route de paris','wimereux',62930,'21-87-87-71','2014-09-01',2,NULL,'M','1996-11-12',NULL),(18,'DEWA','LEON','121,allee des eglantines','dunkerque',59100,'28-30-87-90','2014-09-01',2,NULL,'M','1997-04-03',NULL),(25,'DARTE','REMY',NULL,NULL,NULL,NULL,NULL,1,NULL,NULL,NULL,'SCULPTURE');
/*!40000 ALTER TABLE `etudiants` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Temporary table structure for view `etudiantsnote`
--

DROP TABLE IF EXISTS `etudiantsnote`;
/*!50001 DROP VIEW IF EXISTS `etudiantsnote`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `etudiantsnote` AS SELECT 
 1 AS `idEtudiant`,
 1 AS `nomEtudiant`,
 1 AS `prenomEtudiant`,
...
--
-- Final view structure for view `etudiantsnote`
--
...
/*!50001 VIEW `etudiantsnote` AS select `etudiants`.`idEtudiant` AS `idEtudiant`,`etudiants`.`nomEtudiant` AS `nomEtudiant`,`etudiants`.`prenomEtudiant` AS `prenomEtudiant`,`etudiants`.`adresseEtudiant` AS `adresseEtudiant`,`etudiants`.`villeEtudiant` AS `villeEtudiant`,`etudiants`.`codePostalEtudiant` AS `codePostalEtudiant`,`etudiants`.`telephoneEtudiant` AS `telephoneEtudiant`,`etudiants`.`dateEntreeEtudiant` AS `dateEntreeEtudiant`,`etudiants`.`anneeEtudiant` AS `anneeEtudiant`,`etudiants`.`remarqueEtudiant` AS `remarqueEtudiant`,`etudiants`.`sexeEtudiant` AS `sexeEtudiant`,`etudiants`.`dateNaissanceEtudiant` AS `dateNaissanceEtudiant`,`etudiants`.`HOBBY` AS `HOBBY`,`avoir_note`.`idAvoirNote` AS `idAvoirNote`,`avoir_note`.`idEpreuve` AS `idEpreuve`,`avoir_note`.`note` AS `note` from (`etudiants` left join `avoir_note` on((`etudiants`.`idEtudiant` = `avoir_note`.`idEtudiant`))) */;
...
-- Dump completed on 2021-01-28 17:10:01
