...
--
-- Table structure for table `lignetickets`
--

DROP TABLE IF EXISTS `lignetickets`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `lignetickets` (
  ...
  KEY `fk_ligneTickets_tickets` (`idTicket`),
  KEY `fk_ligneTickets_articles` (`idArticle`),
  CONSTRAINT `fk_ligneTickets_articles` FOREIGN KEY (`idArticle`) REFERENCES `articles` (`idArticle`),
  CONSTRAINT `fk_ligneTickets_tickets` FOREIGN KEY (`idTicket`) REFERENCES `tickets` (`idTicket`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `lignetickets`
--

LOCK TABLES `lignetickets` WRITE;
/*!40000 ALTER TABLE `lignetickets` DISABLE KEYS */;
INSERT INTO `lignetickets` VALUES (1,5,10,3,1,3),(2,2,2.5,2,1,4);
/*!40000 ALTER TABLE `lignetickets` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `modepaiements`
--

DROP TABLE IF EXISTS `modepaiements`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `modepaiements`
--

LOCK TABLES `modepaiements` WRITE;
/*!40000 ALTER TABLE `modepaiements` DISABLE KEYS */;
INSERT INTO `modepaiements` VALUES (1,'Carte bancaire'),(2,'Cheque'),(3,'espece');
/*!40000 ALTER TABLE `modepaiements` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `paiements` (
  ...
  KEY `fk_paiements_ModePaiements` (`idModePaiement`),
  KEY `fk_paiements_Ticket` (`idTicket`),
  CONSTRAINT `fk_paiements_ModePaiements` FOREIGN KEY (`idModePaiement`) REFERENCES `modepaiements` (`idModePaiement`),
  CONSTRAINT `fk_paiements_Ticket` FOREIGN KEY (`idTicket`) REFERENCES `tickets` (`idTicket`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
