...
class EtudiantsManager
{
    ...
    {
        $db=DbConnect::getDb();
        $q=$db->prepare("INSERT INTO Etudiants (nomEtudiant,prenomEtudiant,adresseEtudiant,villeEtudiant) VALUES (:nomEtudiant,:prenomEtudiant,:adresseEtudiant,:villeEtudiant)");
