 ...
 Class Etudiant {
	...
	*/
	public function toString(){
		return "Nom de l'étudiant : ".strtoupper($this->getNomEtudiant())."<br>"	
		."Prénom de l'étudiant : ".ucfirst($this->getPrenomEtudiant())."<br>"
		."Adresse de l'étudiant : ".$this->getAdresseEtudiant()	."<br>"
		."Ville de l'étudiant : ".strtoupper($this->getVilleEtudiant())	;
	}
