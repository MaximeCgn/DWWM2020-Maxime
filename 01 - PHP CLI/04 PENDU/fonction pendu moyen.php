...
{
    echo "Vous avez choisi la difficulté moyenne. Tu es dans la moyenne, et personne ne se souvient des gens moyens.\n";
    $mot = choisirMot();
    ...
    do {
        ...
        if (empty($position)) {
            ...
            echo "Nombres de chances réponses restantes : $essais \n";
        }
    ...
    if ($gagne == 1) {
        echo "Vous avez gagné, on peut commencer à jouer maintenant ? \nLe mot était $mot";
    } else {
        echo "Vous avez perdu, va jouer en facile avec les nullos.\nLe mot était $mot";
    }
}
