...
if ($choix == false) {
    ...
    $CSSPhone_folder = fopen($path . '/' . $nomprojet . '/CSS/' . 'phone.css', "w");
    ...
    $CSSPhone_folder = fopen('./' . $nomprojet . '/CSS/' . 'phone.css', "w");
...
if (is_dir($repository)) {
    $HTML_snippet = '<!doctype html>' . "\n"
        ...
        . "\t" . '<link rel="stylesheet" media="screen and (max-width: 800px)" href="../CSS/phone.css" type="text/css" />' . "\n"
